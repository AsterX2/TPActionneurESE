...
/* USER CODE BEGIN 0 */
//extern BUFFER_SIZE;
extern uint32_t adcBuffer[BUFFER_SIZE]; // Buffer pour stocker les données ADC
...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
	...
	/***************************************************
		...
		//formatage pour l'envoie sur l'uart de la tension ADC
		int uartTxStringLength = snprintf((char *)uartTxBuffer, UART_TX_BUFFER_SIZE, "Valeur : %4d \r\n", u);
		//envoie du buffer sur l'USART
		HAL_UART_Transmit(&huart2, uartTxBuffer, uartTxStringLength, HAL_MAX_DELAY);

		//formatage pour l'envoie sur l'uart du courant calculé mesuré
